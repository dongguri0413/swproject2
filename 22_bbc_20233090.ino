...
#define _DUTY_NEU 1939 // 1500
#define _DUTY_MIN 972 // 1000

#define _SERVO_ANGLE_DIFF  181  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 946 + -4.51*a_value + 7.68E-03*a_value*a_value + -4.59E-06*a_value*a_value*a_value;
}
